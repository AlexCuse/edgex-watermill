...
.PHONY: check
check: ${CHECK_TARGETS}
check: test vet fmt ## Run test and fmt check
...
fix: bin/golangci-lint ## Fix lint violations
	bin/golangci-lint run --disable=godox --fix
...
# Update main targets
golang.mk:
	curl https://raw.githubusercontent.com/sagikazarmark/makefiles/master/go-app/main.mk > golang.mk
